...
class CreatePrincipFactuAvoirsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('princip_factu_avoirs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('princip_factu_avoirs');
    }
}
