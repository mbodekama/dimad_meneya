              ...
              <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="utilities" data-parent="#navbarVerticalCollapse">
                    ...
                    <li class="nav-item  collapsed navChoix"><a class="nav-link" href="#top">Ajouter</a>
                    </li>
                    <li class="nav-item  collapsed navChoix"><a class="nav-link" href="#top">Liste Utilisateur</a>
                    </li>
                  </ul>
                </li>
                @endif
