              ...
              <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="arriv" data-parent="#navbarVerticalCollapse">
                    <li class="nav-item  collapsed firstLog">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="principal" data-parent="#navbarVerticalCollapse">
                    ...
                    <li class="nav-item  collapsed firstLog"><a class="nav-link" href="#top">Approvisionnement</a>
                    </li>
                    <li class="nav-item  collapsed firstLog"><a class="nav-link" href="#top">Liste Approvi.</a>
                    </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse" id="e-commerce" data-parent="#navbarVerticalCollapse">
                      ...
                      <li class="nav-item  collapsed firstLog" ><a class="nav-link" href="#top">Mes ventes</a>
                      </li>
                      <li class="nav-item  collapsed firstLog" ><a class="nav-link" href="#top">Mon stock</a>
                      </li>
              ...
              <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="utilities" data-parent="#navbarVerticalCollapse">
                    ...
                    <li class="nav-item  collapsed firstLog"><a class="nav-link" href="#top">Ajouter</a>
                    </li>
                    <li class="nav-item  collapsed firstLog"><a class="nav-link" href="#top">Liste Utilisateur</a>
                    </li>
                  </ul>
                </li>
                @endif
            ...
            @else
              ...
              @if(userHasSucc(Auth::id()))
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="Succursale" data-parent="#navbarVerticalCollapse">
                    <li class="nav-item  collapsed id="dashSucu">
