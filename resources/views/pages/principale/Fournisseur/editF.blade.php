              ...
              <div class="col-lg-8 pr-lg-2">
                <div class="card mb-3">
                  <div class="card-header">
                    <h5 class="mb-0">Modifier votre fournisseurs</h5>
                  </div>
                      ...
                      <div class="form-row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" id="name" name="name" type="text" required value="{{ $four->fournisseurNom }}">
                           <input type="hidden" value="{{ $four->id }}" name="fourId">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input class="form-control " id="respo" name="respo" type="text" required value="{{ $four->fournisseurRespo }}" >
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group mb-0">
                            <label for="contact">Contact</label>
                            <input class="form-control" id="contact" name="contact" type="number" required value="{{ $four->fournisseurContact }}">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="localite">Email</label>
                            <input class="form-control " required id="email" name="email" type="email" value="{{ $four->fournisseurMail }}">
                          </div>
                        </div>
