<div class="card mb-3">
  ...
  <!--/.bg-holder-->
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-8">
          <h3 class="mb-0 text-primary"> <i class="fas fa-cart-plus"></i> Commandes >livrées</h3>
          <p class="mt-2">Mes  commandes livrées</p>
        </div>
      </div>
    </div>
</div>
                  ...
                  <div class="card h-100">
                    <div class="card-header bg-light">
                     ...
                     {{--  <a href="#"><span class="text-danger"><i class="fas fa-trash-alt">
                      ...
                      <b>Total:</b></span> {{$nbt}} commandes livrées</a>
                    ...
                    @else
                      <div class="alert alert-warning">Aucune commande livrée enregistrée</div>
                    @endif
                  </div>
                </div>
              </div>
